...
//Please note that I use PipelineRunId as ServiceRunId to get all information related to the Pipeline, not only the activity.
...
//Create Union all temp tables and filter for BatchId from Parameter. 
 apimLogs | union appLogs,  sqlLogs,logicAppLogs, ADFLogs
